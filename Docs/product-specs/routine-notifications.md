...
- 인사이트 주간 코칭의 루틴 CTA도 같은 권한 분기를 사용한다
...
- 활성 루틴 저장/수정/삭제는 후보 스케줄 재구성이 성공한 뒤 저장소를 커밋한다
- 스케줄 재구성 실패 시 저장된 루틴은 이전 상태를 유지하고, 이전 활성 루틴 스케줄 복구를 시도한다
...
- 주간 코칭에서 놓친 기존 루틴은 기존 루틴 수정으로, 기록 기반 빈 시간대는 새 루틴 생성으로 연결한다
