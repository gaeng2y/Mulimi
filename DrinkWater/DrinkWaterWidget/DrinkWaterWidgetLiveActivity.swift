...
struct DrinkWaterWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = DrinkWaterWidgetAttributes(name: "Me")
    static let contentState = DrinkWaterWidgetAttributes.ContentState(value: 3)
